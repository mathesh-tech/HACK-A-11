...
def query_gemini(prompt: str) -> dict:
    ...
    try:
        # 4. Print the exact URL being called (masking the key for safety, or full key if they prefer, but better masked)
        print(f"DEBUG GEMINI URL = {GEMINI_URL}?key={api_key[:10]}...")
